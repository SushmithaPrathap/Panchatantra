...
EXECUTE ONBOARD_FLIGHT_PKG.INSERT_FLIGHT('Airbus A320',  TO_TIMESTAMP('2023-04-27 16:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-04-27 23:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'BOS', 'SFO', 'On Time', 300, 2, 0, 6001);
...
EXECUTE ONBOARD_TICKET_PKG.INSERT_TICKET(50005, 4004, 'B7', 'Vegetarian', 'LHR', 'BOS', TO_DATE('2023-04-25', 'YYYY-MM-DD'), 'Business Pro', 'Cancelled', 2345,350.00);
