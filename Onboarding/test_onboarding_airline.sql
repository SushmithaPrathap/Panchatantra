...
EXECUTE airline_pkg.insert_airline('Sk', '');
EXECUTE airline_pkg.insert_airline('SP', ' ');
select * from airlines;
select * from passenger;
--Testing update airline
EXECUTE update_airline_pkg.update_airline_name(NULL, 'British Airways');
EXECUTE update_airline_pkg.update_airline_name(NULL, 'WD6');
--Testing delete airline
EXECUTE delete_airline_pkg.delete_airline(13);