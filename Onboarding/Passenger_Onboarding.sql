...
CREATE OR REPLACE PACKAGE BODY passenger_onboarding_pkg AS
  ...
  BEGIN
    ...
    SELECT passenger_id INTO v_passenger_id FROM passenger WHERE email = p_email;
  ...
  EXCEPTION
    ...
    WHEN NO_DATA_FOUND THEN
      INSERT INTO passenger (passenger_id, age, address, sex, govt_id_nos, first_name, last_name, dob, contact_number, email)
        VALUES (admin.passenger_seq.nextval, p_age, p_address, p_sex, p_govt_id_nos, p_first_name, p_last_name, p_dob, p_contact_number, p_email);
