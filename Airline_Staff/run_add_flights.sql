...
EXECUTE ONBOARD_FLIGHT_PKG.INSERT_FLIGHT('Airbus A380',  TO_TIMESTAMP('2023-04-21 12:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-04-22 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'BOM', 'BOS', 'On Time', 300, 1010, 0, 6001);
